...
const PARAMS: ParamRow[] = [
  ...
  { name: 'transaction_id', req: 'Required', desc: 'Unique conversion ID — used for deduplication. Must be unique per event.', example: 'conv_20260629_001' },
  { name: 'pub', req: 'Recommended', desc: 'Magic Publisher ID — captured from click URL {pub} parameter. Required for publisher attribution.', example: 'cm9xyzmag...' },
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            {[
              { step: '1', title: 'User clicks link', sub: 'Magic tracking link includes pub={publisherId}' },
              { step: '2', title: 'User converts', sub: 'Installs app, registers, applies for loan...' },
              { step: '3', title: 'You fire postback', sub: 'POST to Magic S2S endpoint with event data' },
            ].map(s => (
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 text-sm text-blue-900">
            <strong>Attribution:</strong> The publisher ID is captured by Magic when a user clicks your tracking link (<code className="font-mono text-xs bg-blue-100 px-1 rounded">?pub=&#123;publisherId&#125;</code>). Forward this value in the <code className="font-mono text-xs bg-blue-100 px-1 rounded">pub</code> parameter of the postback. Without it, the conversion cannot be attributed to a publisher.
          </div>
